...
namespace GrandCircusUniversity.Controllers
{
    public class EnrollmentsController : Controller
    {
        ...
        public EnrollmentsController(GrandCircusUniversityContext context)
        {
            _context = context;
        }
        ...
        {
            var grandCircusUniversityContext = _context.Enrollments.Include(e => e.Course).Include(e => e.Student);
            return View(await grandCircusUniversityContext.ToListAsync());
        }
